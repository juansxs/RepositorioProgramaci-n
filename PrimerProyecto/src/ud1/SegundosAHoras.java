...
public class SegundosAHoras {
    public static void main(String[] args) {
        ...
        double minutos = (segundos % 3600.0) / 60.0; // El modulo de 3600 de segundos da los segundos que sobran que no llegan a formar una hora y para para pasar de min a sec divides entre 60
        double segundosCalc = segundos % 60.0; // El modulo de 60 de (segundos % 3600) referencia a los segundos que no llegaron a formar minutos
